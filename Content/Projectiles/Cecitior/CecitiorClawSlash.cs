...
internal class CecitiorClawSlash : ModProjectile
{
    ...
    public override void OnSpawn(IEntitySource source)
    {
        ...
        if (Projectile.ai[2] == 1)
            SoundEngine.PlaySound(Sounds.cecitiorSlice, Projectile.Center);
        else
            SoundEngine.PlaySound(Sounds.clawSwipe.WithVolumeScale(1.5f), Projectile.Center);
    }
...
internal class ClawSlashGreen : ModProjectile
{
    public override string Texture => Helper.Empty;
    const int max = 40;
    public override void SetDefaults()
