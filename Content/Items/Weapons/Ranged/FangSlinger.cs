...
{
    public override string Texture => Helper.AssetPath + "Items/Weapons/Ranged/FangSlinger";
...
{
    public override string Texture => Helper.AssetPath + "Items/Weapons/Ranged/FangSlingerP";
    ...
    {
        Texture2D tex = TextureAssets.Projectile[ProjectileType<CrimsonArrow>()].Value;
        for (int i = -1; i < 2; i++)
        {
            if (i == 0)
                continue;
